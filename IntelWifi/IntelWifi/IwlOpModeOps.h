...
public:
    ...
    virtual void nic_config(struct iwl_op_mode *op_mode) = 0;
    virtual void stop(struct iwl_op_mode *op_mode) = 0;
    virtual void rx(struct iwl_op_mode *op_mode, struct napi_struct *napi, struct iwl_rx_cmd_buffer *rxb) = 0;
